...
check:
	...
	python -c "import json,pathlib; p=pathlib.Path('veip_verifier_core/schemas/veip-evidence-pack.schema.json'); json.loads(p.read_text(encoding='utf-8')); print('OK: schema JSON parses')"
